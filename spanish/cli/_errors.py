...
Every failure inside spanish-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`spanish.cli._output`,
...
# Exit-code policy. Documented in ``spanish-cli learn`` output.
# 0      = success
